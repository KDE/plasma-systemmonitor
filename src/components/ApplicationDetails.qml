...
Page {
    ...
    ColumnLayout {
        ...
        LineChartCard {
            ...
            xRange { from: 0; to: 50 }
            unit: KSysGuard.Units.UnitPercent
        ...
        LineChartCard {
            ...
            KSysGuard.Sensor { id: totalMemorySensor; sensorId: "mem/physical/total" }
        }
        Label {
            text: i18n("Network")
        }
        LineChartCard {
            ...
            legendVisible: false
            xRange { from: 0; to: 50 }
            unit: KSysGuard.Units.UnitKiloByteRate
