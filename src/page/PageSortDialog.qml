        ...
        delegate: Item {
            ...
            ItemDelegate {
                ...
                contentItem: RowLayout {
                    ...
                    states: [
                        State {
                            name: "noChanges"
                            extend: "localChanges"
                            when: listItemContainer.filesWriteable == Page.PageManager.NotWriteable
                            PropertyChanges {
                                target: removeButton;
                                enabled: false;
                            }
                        ...
                        State {
                            ...
                            when:  listItemContainer.filesWriteable == Page.PageManager.LocalChanges && listItemContainer.shouldRemoveFiles
                            PropertyChanges {
                                target: removeButton
                                icon.name: "edit-redo"
                        ...
                        State {
                            name: "localChanges"
                            when: listItemContainer.filesWriteable == Page.PageManager.LocalChanges
                            PropertyChanges {
                                target: removeButton
                        ...
                        State {
                            name: "remove"
                            when: listItemContainer.filesWriteable == Page.PageManager.AllWriteable && listItemContainer.shouldRemoveFiles
                            PropertyChanges {
                                target: removeButton
                                icon.name: "edit-undo"
                        ...
                        State {
                            name: "removeable"
                            when: listItemContainer.filesWriteable == Page.PageManager.AllWriteable
                            PropertyChanges {
                                target: removeButton
                ...
                background: Rectangle {
                    color: listItemContainer.filesWriteable == Page.PageManager.AllWriteable && listItemContainer.shouldRemoveFiles ? Kirigami.Theme.negativeBackgroundColor : Kirigami.Theme.backgroundColor
                }
            }
        }
    }
            ...
            function createModel() {
                ...
                for (var i = 0; i < sortModel.rowCount(); ++i) {
                    ...
                    if (sortModel.data(index, Page.PageSortModel.ShouldRemoveFilesRole)
                        && sortModel.data(index, Page.PagesModel.FilesWriteableRole) == Page.PageManager.AllWriteable) {
                        continue
                    }
